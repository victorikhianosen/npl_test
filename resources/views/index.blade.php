                            ...
                            <div class="px-6 pt-4 pb-2">
                                ...
                                @if (json_last_error() === JSON_ERROR_NONE && is_array($files))
                                    ...
                                    @foreach ($files as $file)
                                        <a href="{{ asset($file) }}" target="_blank" class="inline-block bg-blue-500 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2 hover:bg-blue-700">
                                            View
                                        </a>
                                        <a href="{{ asset($file) }}" class="inline-block bg-green-500 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2 hover:bg-green-700" download>
                                            Download
                                        </a>
                                    @endforeach
                                @else
                                    {{-- If it's a single file, display the single view/download link --}}
                                    ...
                                    <a href="{{ asset($book->file) }}" class="inline-block bg-green-500 rounded-full px-3 py-1 text-sm font-semibold text-white mr-2 mb-2 hover:bg-green-700" download>
                                        Download
                                    </a>
                                @endif
                            </div>
